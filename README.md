...
- [int enableUSB()](#int-enableusb)
- [int disableUSB()](#int-disableusb)
- [int enableWifi()](#int-enablewifi)
- [int disableWifi()](#int-disablewifi)
...
- [MePOSReceiptSingleCharLine(char chr)](#meposreceiptsinglecharlinechar-chr-1)
